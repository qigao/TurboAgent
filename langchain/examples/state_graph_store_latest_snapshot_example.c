...
static json_value_t *state_graph_store_example_make_string_array(
    const char *value) {
...
static turbo_state_graph_t *state_graph_store_example_create_graph(
  ...
  if (turbo_state_graph_add_json_value_node(graph, "start", state_graph_store_example_start_node,
                                      (void *)payload) != TURBO_STATE_GRAPH_OK ||
      turbo_state_graph_add_json_value_node(graph, "done", state_graph_store_example_done_node, NULL) !=
...
static int state_graph_store_example_print_thread_view(turbo_state_graph_t *graph,
  ...
  printf(
      ...
      "  has_pending_run: %s\n",
      label,
      state_graph_store_example_text(turbo_runtime_json_value_as_string(
