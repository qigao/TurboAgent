...
static void event_stream_capture_sink(const turbo_runtime_data_bind_value_t *event,
                                      void *user_data) {
...
spec("turbo event runtime") {
  describe("canonical runtime events") {
    ...
    it("should classify canonical events by stream mode") {
      turbo_runtime_data_bind_value_t *tool_calls = turbo_runtime_data_bind_value_create_array();
      turbo_runtime_data_bind_value_t *model =
          turbo_event_model_create_bind("resp_1", "hello", tool_calls);
      turbo_runtime_data_bind_value_t *trace =
          turbo_event_trace_create_bind("node_start", "planner", "{}", 0);
      turbo_runtime_data_bind_value_t *tool =
          turbo_event_tool_result_create_bind("sum", "{}", "ok", NULL, 0);
      turbo_runtime_data_bind_value_t *handoff =
          turbo_event_handoff_create_bind("requested", "planner", "executor",
                                          "delegate", "planner", 0);
      ...
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_ALL, model), 1);
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_ALL, trace), 1);
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_MESSAGES, model), 1);
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_MESSAGES, trace), 0);
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_UPDATES, model), 0);
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_UPDATES, trace), 1);
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_UPDATES, tool), 1);
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_UPDATES, handoff), 1);
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_TOOLS, tool), 1);
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_TOOLS, trace), 0);
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_DEBUG, trace), 1);
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_DEBUG, model), 0);
      check_int_eq(turbo_event_stream_mode_accepts_bind((turbo_event_stream_mode_t)99, model), 0);
      check_int_eq(turbo_event_stream_mode_accepts_bind(TURBO_EVENT_STREAM_ALL, NULL), 0);

      turbo_runtime_data_bind_value_destroy(handoff);
      turbo_runtime_data_bind_value_destroy(tool);
      turbo_runtime_data_bind_value_destroy(trace);
      turbo_runtime_data_bind_value_destroy(model);
      turbo_runtime_data_bind_value_destroy(tool_calls);
    }
    ...
    it("should filter stream sink events by mode") {
      ...
      turbo_event_stream_filter_sink_bind(trace, &filter);
      check_int_eq(capture.count, 0);
      turbo_event_stream_filter_sink_bind(model, &filter);
      ...
      turbo_event_stream_filter_sink_bind(trace, &filter);
      check_int_eq(capture.count, 2);
      turbo_event_stream_filter_sink_bind(trace, NULL);
      check_int_eq(capture.count, 2);
