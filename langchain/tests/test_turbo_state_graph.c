...
static turbo_runtime_data_bind_value_t *make_string_array_value(const char *value) {
...
static turbo_runtime_data_bind_value_t *make_profile_value(const char *name,
                                                           const char *kind) {
  ...
  if (name) {
    check_int_eq(turbo_runtime_data_bind_object_set(
                     profile, "name", turbo_runtime_data_bind_value_create_string(name)),
                 TURBO_RUNTIME_DATA_BIND_OK);
  }
  if (kind) {
    check_int_eq(turbo_runtime_data_bind_object_set(
                     profile, "kind", turbo_runtime_data_bind_value_create_string(kind)),
                 TURBO_RUNTIME_DATA_BIND_OK);
  }
  return profile;
}
...
static turbo_state_graph_t *create_branching_graph(void) {
  ...
  default_value = turbo_runtime_data_bind_value_create_object();
  config.reducer = TURBO_STATE_GRAPH_REDUCER_MERGE_OBJECT;
  config.value_kind = TURBO_RUNTIME_DATA_BIND_VALUE_OBJECT;
  config.default_value = default_value;
  check_int_eq(turbo_state_graph_add_channel(graph, "profile", &config), TURBO_STATE_GRAPH_OK);
  turbo_runtime_data_bind_value_destroy(default_value);

  default_value = turbo_runtime_data_bind_value_create_string("left");
...
static int branch_seed_node(turbo_state_graph_exec_ctx_t *ctx, void *user_data) {
  ...
  check_int_eq(turbo_runtime_data_bind_object_set(
               ...
               TURBO_RUNTIME_DATA_BIND_OK);
  check_int_eq(
      turbo_runtime_data_bind_object_set(ctx->update, "profile",
...
static int branch_left_node(turbo_state_graph_exec_ctx_t *ctx, void *user_data) {
  ...
  check_int_eq(turbo_runtime_data_bind_object_set(
                   ctx->update, "count", turbo_runtime_data_bind_value_create_int64(10)),
               TURBO_RUNTIME_DATA_BIND_OK);
  check_int_eq(turbo_runtime_data_bind_object_set(
...
static int branch_right_node(turbo_state_graph_exec_ctx_t *ctx, void *user_data) {
  ...
  check_int_eq(turbo_runtime_data_bind_object_set(
                   ctx->update, "count", turbo_runtime_data_bind_value_create_int64(20)),
               TURBO_RUNTIME_DATA_BIND_OK);
  check_int_eq(turbo_runtime_data_bind_object_set(
...
static int mode_is_left(const turbo_runtime_data_bind_value_t *state, void *user_data) {
  const char *expected = (const char *)user_data;
  const char *mode = turbo_runtime_data_bind_value_as_string(
      turbo_runtime_data_bind_object_get(state, "mode"));
...
static int invalid_node(turbo_state_graph_exec_ctx_t *ctx, void *user_data) {
  ...
  check_int_eq(turbo_runtime_data_bind_object_set(
                   ctx->update, "missing", turbo_runtime_data_bind_value_create_bool(1)),
               TURBO_RUNTIME_DATA_BIND_OK);
  return 0;
}
...
static int send_dispatch_node(turbo_state_graph_exec_ctx_t *ctx, void *user_data) {
  ...
  turbo_runtime_data_bind_value_t *second = turbo_runtime_data_bind_value_create_object();
  ...
  check_int_eq(turbo_runtime_data_bind_object_set(
               ...
               TURBO_RUNTIME_DATA_BIND_OK);
  check_int_eq(turbo_runtime_data_bind_object_set(first, "messages",
                                                  make_string_array_value("a")),
               TURBO_RUNTIME_DATA_BIND_OK);
  check_int_eq(turbo_runtime_data_bind_object_set(second, "messages",
  ...
  turbo_runtime_data_bind_value_destroy(second);
  turbo_runtime_data_bind_value_destroy(first);
  return 0;
}
...
static int child_answer_node(turbo_state_graph_exec_ctx_t *ctx, void *user_data) {
  const char *prompt = turbo_runtime_data_bind_value_as_string(
      turbo_runtime_data_bind_object_get(ctx->state, "prompt"));

  (void)user_data;
  check_not_null(prompt);
  check_int_eq(turbo_runtime_data_bind_object_set(
                   ctx->update, "answer",
                   turbo_runtime_data_bind_value_create_string(prompt)),
               TURBO_RUNTIME_DATA_BIND_OK);
  return 0;
}
...
static turbo_state_graph_t *create_child_answer_graph(void) {
  ...
  check_not_null(graph);
  default_value = turbo_runtime_data_bind_value_create_string("");
  config.reducer = TURBO_STATE_GRAPH_REDUCER_REPLACE;
  config.value_kind = TURBO_RUNTIME_DATA_BIND_VALUE_STRING;
  config.default_value = default_value;
  ...
  check_int_eq(turbo_state_graph_add_bind_node(graph, "answer", child_answer_node, NULL),
               TURBO_STATE_GRAPH_OK);
...
static turbo_state_graph_t *create_review_graph(
  ...
  check_not_null(graph);
  check_int_eq(turbo_state_graph_add_bind_node(graph, "start", review_node, (void *)review_payload),
               TURBO_STATE_GRAPH_OK);
  check_int_eq(turbo_state_graph_add_bind_node(graph, "done", done_node, NULL),
               TURBO_STATE_GRAPH_OK);
  check_int_eq(turbo_state_graph_add_bind_edge(graph, "start", "done", NULL, NULL),
               TURBO_STATE_GRAPH_OK);
...
static void check_review_thread_snapshot_state(turbo_state_graph_t *graph, const char *thread_id,
  ...
  check_int_eq((int)turbo_runtime_data_bind_value_as_bool(
...
spec("turbo state graph") {
  ...
  describe("reducers and history") {
    ...
    it("should merge channel updates and expose state history") {
      ...
      turbo_runtime_data_bind_value_t *history_entry = NULL;
      turbo_runtime_data_bind_value_t *checkpoint = NULL;
      turbo_runtime_data_bind_value_t *checkpoints = NULL;
      turbo_runtime_data_bind_value_t *context = NULL;
      const turbo_runtime_data_bind_value_t *messages = NULL;
      const turbo_runtime_data_bind_value_t *profile = NULL;
      const turbo_runtime_data_bind_value_t *first_history = NULL;
      const char *first_history_id = NULL;
      const char *first_checkpoint_id = NULL;

      check_int_eq(turbo_runtime_data_bind_object_set(
                       input, "mode", turbo_runtime_data_bind_value_create_string("left")),
                   TURBO_RUNTIME_DATA_BIND_OK);

      check_int_eq(turbo_state_graph_add_bind_node(graph, "seed", branch_seed_node, NULL),
                   TURBO_STATE_GRAPH_OK);
      check_int_eq(turbo_state_graph_add_bind_node(graph, "route", branch_route_node, NULL),
                   TURBO_STATE_GRAPH_OK);
      check_int_eq(turbo_state_graph_add_bind_node(graph, "left", branch_left_node, NULL),
                   TURBO_STATE_GRAPH_OK);
      check_int_eq(turbo_state_graph_add_bind_node(graph, "right", branch_right_node, NULL),
                   TURBO_STATE_GRAPH_OK);
      check_int_eq(turbo_state_graph_add_bind_edge(graph, "seed", "route", NULL, NULL),
                   TURBO_STATE_GRAPH_OK);
      check_int_eq(
          turbo_state_graph_add_bind_edge(graph, "route", "left", mode_is_left, "left"),
          TURBO_STATE_GRAPH_OK);
      check_int_eq(turbo_state_graph_add_bind_edge(graph, "route", "right", NULL, NULL),
                   TURBO_STATE_GRAPH_OK);
      ...
      check_int_eq((int)turbo_runtime_data_bind_value_as_int64(
                       turbo_runtime_data_bind_object_get(state, "count"), 0),
                   11);
      messages = turbo_runtime_data_bind_object_get(state, "messages");
      check_size_eq(turbo_runtime_data_bind_value_size(messages), 3);
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_array_get(messages, 0)),
                   "seed");
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_array_get(messages, 2)),
                   "left");
      profile = turbo_runtime_data_bind_object_get(state, "profile");
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(profile, "name")),
                   "alpha");
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(profile, "kind")),
                   "router");

      check_int_eq(turbo_state_graph_list_state_history(graph, result.run_id, &history),
                   TURBO_STATE_GRAPH_OK);
      check_size_eq(turbo_runtime_data_bind_value_size(history), 4);
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(
                           turbo_runtime_data_bind_array_get(history, 0), "source_kind")),
                   "start");
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(
                           turbo_runtime_data_bind_array_get(history, 2), "source_name")),
                   "route");
      first_history = turbo_runtime_data_bind_array_get(history, 0);
      first_history_id = turbo_runtime_data_bind_value_as_string(
          turbo_runtime_data_bind_object_get(first_history, "history_entry_id"));
      first_checkpoint_id = turbo_runtime_data_bind_value_as_string(
          turbo_runtime_data_bind_object_get(first_history, "checkpoint_id"));
      ...
      check_int_eq(turbo_state_graph_get_latest_run(graph, "thread-alpha", &latest_run),
                   TURBO_STATE_GRAPH_OK);
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(latest_run, "run_id")),
                   result.run_id);

      check_int_eq(turbo_state_graph_list_runs(graph, "thread-alpha", &runs),
                   TURBO_STATE_GRAPH_OK);
      check_size_eq(turbo_runtime_data_bind_value_size(runs), 1);

      check_int_eq(turbo_state_graph_get_history_entry(graph, first_history_id, &history_entry),
                   TURBO_STATE_GRAPH_OK);
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(history_entry, "history_entry_id")),
                   first_history_id);

      check_int_eq(turbo_state_graph_get_checkpoint(graph, first_checkpoint_id, &checkpoint),
                   TURBO_STATE_GRAPH_OK);
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(checkpoint, "checkpoint_id")),
                   first_checkpoint_id);

      check_int_eq(turbo_state_graph_list_checkpoints(graph, result.run_id, &checkpoints),
                   TURBO_STATE_GRAPH_OK);
      check_size_eq(turbo_runtime_data_bind_value_size(checkpoints), 4);

      check_int_eq(
          turbo_state_graph_get_checkpoint_context(graph, first_checkpoint_id, &context),
          TURBO_STATE_GRAPH_OK);
      check_not_null(turbo_runtime_data_bind_object_get(context, "checkpoint"));
      check_not_null(turbo_runtime_data_bind_object_get(context, "run"));
      check_not_null(turbo_runtime_data_bind_object_get(context, "thread"));
      check_not_null(turbo_runtime_data_bind_object_get(context, "branch_tree"));
      ...
      turbo_runtime_data_bind_value_destroy(checkpoints);
      turbo_runtime_data_bind_value_destroy(checkpoint);
      turbo_runtime_data_bind_value_destroy(history_entry);
    ...
    it("should reject updates to undeclared channels") {
      ...
      turbo_state_graph_channel_config_t config = {0};
      turbo_runtime_data_bind_value_t *default_value = turbo_runtime_data_bind_value_create_bool(0);
      turbo_state_graph_run_result_t result = {0};
      turbo_runtime_data_bind_value_t *state = NULL;
      ...
      turbo_runtime_data_bind_value_destroy(default_value);
      check_int_eq(turbo_state_graph_add_bind_node(graph, "bad", invalid_node, NULL),
                   TURBO_STATE_GRAPH_OK);
  ...
  describe("update and time travel") {
    ...
    it("should apply host updates and resume an interrupted run") {
      ...
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                   ...
                   "interrupted");
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(pending_run, "run_id")),
                   result.run_id);
      turbo_runtime_data_bind_value_destroy(runs);
      turbo_runtime_data_bind_value_destroy(pending_run);
      turbo_runtime_data_bind_value_destroy(latest_run);
      ...
      check_true(turbo_runtime_data_bind_value_as_bool(
          turbo_runtime_data_bind_object_get(state, "approved"), 0));
      turbo_runtime_data_bind_value_destroy(state);
      state = NULL;
    ...
    it("should round-trip snapshot state and resume the imported pending run") {
      ...
      turbo_runtime_data_bind_value_t *patch = turbo_runtime_data_bind_value_create_object();
      turbo_runtime_data_bind_value_t *thread_state = NULL;
      turbo_runtime_data_bind_value_t *restored_state = NULL;
      turbo_runtime_data_bind_value_t *pending_run = NULL;
      turbo_runtime_data_bind_value_t *history = NULL;
      char *snapshot = NULL;
      ...
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                   ...
                   result.run_id);
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(pending_run, "status")),
                   "interrupted");

      check_int_eq(turbo_state_graph_get_thread_state(restored, "thread-snapshot", &restored_state),
                   TURBO_STATE_GRAPH_OK);
      check_true(turbo_runtime_data_bind_value_as_bool(
          turbo_runtime_data_bind_object_get(restored_state, "approved"), 0));
      check_size_eq(turbo_runtime_data_bind_value_size(
                        turbo_runtime_data_bind_object_get(restored_state, "messages")),
                    2);

      check_int_eq(turbo_state_graph_list_state_history(restored, result.run_id, &history),
                   TURBO_STATE_GRAPH_OK);
      check_size_eq(turbo_runtime_data_bind_value_size(history), 3);
      turbo_runtime_data_bind_value_destroy(history);
      history = NULL;
      ...
      check_true(turbo_runtime_data_bind_value_as_bool(
          turbo_runtime_data_bind_object_get(state, "approved"), 0));
      check_size_eq(turbo_runtime_data_bind_value_size(
                        turbo_runtime_data_bind_object_get(state, "messages")),
                    3);
      ...
      turbo_runtime_data_bind_value_destroy(history);
      turbo_runtime_data_bind_value_destroy(state);
      turbo_runtime_data_bind_value_destroy(restored_state);
      turbo_runtime_data_bind_value_destroy(pending_run);
      turbo_runtime_data_bind_value_destroy(thread_state);
      turbo_runtime_data_bind_value_destroy(patch);
    ...
    it("should fork and resume from a historical state") {
      ...
      turbo_state_graph_run_result_t resumed = {0};
      turbo_runtime_data_bind_value_t *input = turbo_runtime_data_bind_value_create_object();
      turbo_runtime_data_bind_value_t *fork_patch = turbo_runtime_data_bind_value_create_object();
      turbo_runtime_data_bind_value_t *resume_patch = turbo_runtime_data_bind_value_create_object();
      turbo_runtime_data_bind_value_t *state = NULL;
      turbo_runtime_data_bind_value_t *thread_state = NULL;
      turbo_runtime_data_bind_value_t *history = NULL;
      const turbo_runtime_data_bind_value_t *seed_entry = NULL;
      const char *seed_history_id = NULL;
      turbo_runtime_data_bind_value_t *tree = NULL;

      check_int_eq(turbo_runtime_data_bind_object_set(
                       input, "mode", turbo_runtime_data_bind_value_create_string("left")),
                   TURBO_RUNTIME_DATA_BIND_OK);
      check_int_eq(turbo_runtime_data_bind_object_set(
                       fork_patch, "mode", turbo_runtime_data_bind_value_create_string("right")),
                   TURBO_RUNTIME_DATA_BIND_OK);
      check_int_eq(turbo_runtime_data_bind_object_set(
                       resume_patch, "mode", turbo_runtime_data_bind_value_create_string("right")),
                   TURBO_RUNTIME_DATA_BIND_OK);
      ...
      check_int_eq(turbo_state_graph_list_state_history(graph, result.run_id, &history),
                   TURBO_STATE_GRAPH_OK);
      seed_entry = turbo_runtime_data_bind_array_get(history, 1);
      check_not_null(seed_entry);
      seed_history_id = turbo_runtime_data_bind_value_as_string(
          turbo_runtime_data_bind_object_get(seed_entry, "history_entry_id"));
      ...
      check_int_eq(turbo_state_graph_get_thread_state(graph, "thread-branch", &thread_state),
                   TURBO_STATE_GRAPH_OK);
      check_int_eq((int)turbo_runtime_data_bind_value_as_int64(
                       turbo_runtime_data_bind_object_get(thread_state, "count"), 0),
                   11);
      turbo_runtime_data_bind_value_destroy(thread_state);
      thread_state = NULL;
      turbo_runtime_data_bind_value_destroy(state);
      ...
      check_int_eq(turbo_state_graph_get_branch_tree(graph, "thread-branch", &tree),
                   TURBO_STATE_GRAPH_OK);
      check_size_eq(turbo_runtime_data_bind_value_size(
                        turbo_runtime_data_bind_object_get(tree, "branches")),
                    3);

      turbo_runtime_data_bind_value_destroy(tree);
      turbo_runtime_data_bind_value_destroy(thread_state);
      turbo_runtime_data_bind_value_destroy(state);
      turbo_runtime_data_bind_value_destroy(history);
      turbo_runtime_data_bind_value_destroy(resume_patch);
      turbo_runtime_data_bind_value_destroy(fork_patch);
      turbo_runtime_data_bind_value_destroy(input);
      turbo_state_graph_destroy(graph);
    }
  }
  ...
  describe("subgraphs") {
    ...
    it("should run a child state graph node and merge its result into the parent state") {
      ...
      turbo_runtime_data_bind_value_t *input = turbo_runtime_data_bind_value_create_object();
      turbo_runtime_data_bind_value_t *state = NULL;
      turbo_runtime_data_bind_value_t *child_run = NULL;
      const turbo_runtime_data_bind_value_t *child_result = NULL;
      const turbo_runtime_data_bind_value_t *child_state = NULL;

      check_int_eq(turbo_runtime_data_bind_object_set(
                       input, "prompt", turbo_runtime_data_bind_value_create_string("write-plan")),
                   TURBO_RUNTIME_DATA_BIND_OK);
      check_int_eq(turbo_state_graph_start(parent, "parent-thread", input, NULL, &result, &state),
                   TURBO_STATE_GRAPH_OK);
      child_result = turbo_runtime_data_bind_object_get(state, "child_result");
      check_not_null(child_result);
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(child_result, "status")),
                   "completed");
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(child_result, "thread_id")),
                   "child-thread");
      child_state = turbo_runtime_data_bind_object_get(child_result, "state");
      check_not_null(child_state);
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(child_state, "prompt")),
                   "write-plan");
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(child_state, "answer")),
                   "write-plan");

      check_int_eq(turbo_state_graph_get_latest_run(child, "child-thread", &child_run),
                   TURBO_STATE_GRAPH_OK);
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_object_get(child_run, "status")),
                   "completed");

      turbo_runtime_data_bind_value_destroy(child_run);
      turbo_runtime_data_bind_value_destroy(state);
      turbo_runtime_data_bind_value_destroy(input);
  ...
  describe("command and send") {
    ...
    it("should let command goto override static edges") {
      ...
      check_int_eq(turbo_state_graph_add_bind_node(graph, "start", command_start_node, NULL),
                   TURBO_STATE_GRAPH_OK);
      check_int_eq(turbo_state_graph_add_bind_node(graph, "left", command_left_node, NULL),
                   TURBO_STATE_GRAPH_OK);
      check_int_eq(turbo_state_graph_add_bind_node(graph, "right", command_right_node, NULL),
                   TURBO_STATE_GRAPH_OK);
      check_int_eq(turbo_state_graph_add_bind_edge(graph, "start", "left", NULL, NULL),
                   TURBO_STATE_GRAPH_OK);
      check_int_eq(turbo_state_graph_set_entry(graph, "start"), TURBO_STATE_GRAPH_OK);
      ...
      check_int_eq(turbo_state_graph_start(graph, "thread-command", NULL, NULL, &result, &state),
                   TURBO_STATE_GRAPH_OK);
      messages = turbo_runtime_data_bind_object_get(state, "messages");
      check_size_eq(turbo_runtime_data_bind_value_size(messages), 2);
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_array_get(messages, 0)),
                   "start");
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_array_get(messages, 1)),
                   "right");
    ...
    it("should fan out dynamic sends and reduce target updates back into state") {
      ...
      check_int_eq(turbo_state_graph_add_bind_node(graph, "dispatch", send_dispatch_node, NULL),
                   TURBO_STATE_GRAPH_OK);
      check_int_eq(turbo_state_graph_add_bind_node(graph, "worker", send_worker_node, NULL),
                   TURBO_STATE_GRAPH_OK);
      ...
      check_int_eq(turbo_state_graph_start(graph, "thread-send", NULL, NULL, &result, &state),
                   TURBO_STATE_GRAPH_OK);
      messages = turbo_runtime_data_bind_object_get(state, "messages");
      check_size_eq(turbo_runtime_data_bind_value_size(messages), 5);
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_array_get(messages, 0)),
                   "dispatch");
      check_str_eq(turbo_runtime_data_bind_value_as_string(
      ...
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                   ...
                   "worker");
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_array_get(messages, 3)),
                   "b");
      check_str_eq(turbo_runtime_data_bind_value_as_string(
                       turbo_runtime_data_bind_array_get(messages, 4)),
                   "worker");
