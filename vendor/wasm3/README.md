...
| ☑ Custom page size                           | ☑ Arena memory management          |
| ⏳ Multiple memories                          |
| ⏳ Reference types                            |
...
Wasm3 in this repository has been enhanced with **Arena Memory Management** support. This allows you to bind a `turbo_arena` to a thread session, ensuring all subsequent Wasm3 allocations (metacode pages, backtrace frames, internal module structures) are performed within the arena.
...
// 3. Perform Wasm3 operations (all allocations go to arena)
